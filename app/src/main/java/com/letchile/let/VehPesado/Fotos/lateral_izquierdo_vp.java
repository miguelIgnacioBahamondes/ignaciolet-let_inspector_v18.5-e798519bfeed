...
public class lateral_izquierdo_vp extends AppCompatActivity {
    ...
    Intent servis;
    private TextView textCant10,contPost10, textCant11,contPost11, textCantVI,contPostVI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contPost10.setText(String.valueOf(db.cantidadF(Integer.parseInt(id_inspeccion),"LateralIzquierdo")));

        textCant11 = findViewById(R.id.textCant11);
        contPost11 = findViewById(R.id.contPost11);
        contPost11.setText(String.valueOf(db.cantidadF(Integer.parseInt(id_inspeccion),"Adicional LateralIzquierdo")));

        textCantVI = findViewById(R.id.textCantVI);
        contPostVI = findViewById(R.id.contPostVI);
        contPostVI.setText(String.valueOf(db.cantidadF(Integer.parseInt(id_inspeccion),"Foto Danio LateralIzquierdo")));

        //Log.i("sss","sss" + db.cantidadF(Integer.parseInt(id_inspeccion),"Adicional LateralIzquierdo") );
        ...
        btnFotoAdicionalPosterior.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                funcionCamara(id_inspeccion,"_Foto_Adicional_LateralIzquierdo_VP.jpg",TAKE_ADDPOVP);
        ...
        if(resultCode== RESULT_OK){
            switch(requestCode){
                case TAKE_POSTERIOR:
                    ...
                    db.insertaFoto(Integer.parseInt(id_inspeccion),db.correlativoFotos(Integer.parseInt(id_inspeccion)),nombreimagen, "LateralIzquierdo",0,imagenPosterior, 0);

                    servis = new Intent(lateral_izquierdo_vp.this, TransferirFoto.class);
                    servis.putExtra("comentario","LateralIzquierdo");
                    servis.putExtra("id_inspeccion",id_inspeccion);
                    startService(servis);


                    int cantFoto10=db.cantidadF(Integer.parseInt(id_inspeccion),"LateralIzquierdo");
                    cantFoto10= cantFoto10 +1;
                    db.insertCantidadFoto(Integer.parseInt(id_inspeccion),"LateralIzquierdo",cantFoto10);
                    contPost10.setText(String.valueOf(cantFoto10));

                    Log.i("ddd","ddd" + db.insertCantidadFoto(Integer.parseInt(id_inspeccion),"LateralIzquierdo",cantFoto10));
                    break;
                ...
                case TAKE_ADDPOVP:
                    ...
                    db.insertaFoto(Integer.parseInt(id_inspeccion),db.correlativoFotos(Integer.parseInt(id_inspeccion)),nombreimagen, "Adicional LateralIzquierdo",0,imagenAddPosterior, 0);

                    servis = new Intent(lateral_izquierdo_vp.this, TransferirFoto.class);
                    servis.putExtra("comentario","Adicional LateralIzquierdo");
                    servis.putExtra("id_inspeccion",id_inspeccion);
                    startService(servis);


                    int cantFoto11=db.cantidadF(Integer.parseInt(id_inspeccion),"Adicional LateralIzquierdo");
                    cantFoto11= cantFoto11 +1;
                    db.insertCantidadFoto(Integer.parseInt(id_inspeccion),"Adicional LateralIzquierdo",cantFoto11);
                ...
                case TAKE_DANOPVP:
                    ...
                    db.insertarComentarioFoto(Integer.parseInt(id_inspeccion),edtDescripcionDañoPvp.getText().toString(),"LateralIzquierdo");
                    String comentarito = db.comentarioFoto(Integer.parseInt(id_inspeccion),"LateralIzquierdo");
                    ...
                    int cantFotoVI=db.cantidadF(Integer.parseInt(id_inspeccion),"Foto Danio LateralIzquierdo");
                    cantFotoVI= cantFotoVI +1;
                    db.insertCantidadFoto(Integer.parseInt(id_inspeccion),"Foto Danio LateralIzquierdo",cantFotoVI);
                    contPostVI.setText(String.valueOf(cantFotoVI));
    ...
    public void Seccion1(View view){
        if(btnFotoPosterior.getVisibility()==View.VISIBLE){
            ...
            textCantVI.setVisibility(View.GONE);
            contPostVI.setVisibility(View.GONE);

            String imagenPosterior = db.foto(Integer.parseInt(id_inspeccion),"LateralIzquierdo");
            String imagenAdicional = db.foto(Integer.parseInt(id_inspeccion),"Adicional LateralIzquierdo");
    ...
    public void Seccion2(View view){
        if(edtDescripcionDañoPvp.getVisibility()==View.VISIBLE){
            ...
            textCantVI.setVisibility(View.VISIBLE);
            contPostVI.setVisibility(View.VISIBLE);
            ...
            String imagenDanoPosterior = db.foto(Integer.parseInt(id_inspeccion),db.comentarioFoto(Integer.parseInt(id_inspeccion),"LateralIzquierdo"));
